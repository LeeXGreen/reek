...
describe FeatureEnvy do
  ...
  context 'with 2 calls to a parameter' do
    it 'reports the smell' do
      ...
      ').to reek_only_of(:FeatureEnvy,  name: 'arga')
    end
  end
  ...
  it 'should report highest affinity' do
    src = <<-EOS
      ...
      EOS
    expect(src).to reek_only_of(:FeatureEnvy,  name: 'total')
  end
  ...
  it 'should not be fooled by duplication' do
    ...
    ').to reek_only_of(:Duplication,  name: 'thing.pig')
  end
  ...
  it 'should report many calls to lvar' do
    ...
    ').to reek_only_of(:FeatureEnvy,  name: 'lv')
    #
    # def moved_version
    #   price + tax
    # end
